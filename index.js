...
const IntroDialog = require("./dialogs/IntroDialog");
...
const userStateAccessor = userState.createProperty("main");
const userLocationAccessor = userState.createProperty("location");
...
const { LuisRecognizer } = require("./helpers");
